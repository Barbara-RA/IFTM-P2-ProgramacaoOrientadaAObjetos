...
public class App {
    ...
    public static void main(String[] args) {
        ...
        validacao.add("Caio:123");
        validacao.add("Thiago:456");
        validacao.add("Fernando:789");
        
        Transacao t = new Transacao();
        Cliente cl = new Cliente("Barbara","00000000000");
        Conta co = new Conta(123456,cl,5000.0f);
